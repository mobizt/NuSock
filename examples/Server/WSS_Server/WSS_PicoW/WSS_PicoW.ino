/**
 * NuSock Secure WebSocket Server (WSS) RPi Pico W Example
 ...
 * that matches your RPi Pico W's IP address (Common Name/SAN).
 * * 1. Open the provided 'keygen.py' Python script.
 * 2. Edit the 'ESP_IP' variable in the script to match your RPi Pico W's IP address.
 * (It is recommended to set a Static IP on your RPi Pico W logic or Router).
 * 3. Run the script: `python keygen.py`
 * 4. Copy the output (server_cert and server_key) and paste it into this sketch below.
 * =================================================================================
 * STEP 2: HOW TO TEST
 * =================================================================================
 * Ensure your PC and RPi Pico W are on the same Wi-Fi network.
 *
